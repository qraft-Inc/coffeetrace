...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-coffee-50 to-white">
      ...
      <section className="py-20 bg-gradient-to-br from-coffee-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-coffee-900 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-xl">
              ...
              <p className="text-coffee-600">Track lots, monitor yields, manage certifications, wallet, and loans all in one place.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-xl">
              ...
              <h3 className="text-xl font-bold text-coffee-900 mb-2">Coffee & Agro Marketplace</h3>
              <p className="text-coffee-600">Browse coffee listings and purchase farming inputs with verified quality and origin.</p>
            </div>
          </div>
        </div>
      </section>
...
function FeatureCard({ icon, title, description, color = 'blue' }) {
  ...
  return (
    <article className="p-6 bg-white rounded-xl hover:shadow-xl transition-all border border-coffee-100 hover:border-primary-200 group">
      <div className={`p-3 rounded-lg mb-4 inline-block ${colorClasses[color]}`}>
