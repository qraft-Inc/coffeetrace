...
import { Bell, User, Building, Mail, Globe, Lock } from 'lucide-react';

export default function BuyerSettingsPage() {
  const [settings, setSettings] = useState({
    companyName: 'Coffee Importers Inc',
    contactName: 'Jane Smith',
    email: 'jane@coffeeimporters.com',
    phone: '+1 555-0123',
    address: '123 Trade Street, New York, USA',
    preferredOrigin: 'Rwanda',
        ...
        <div className="max-w-4xl space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="px-6 py-4">
              <button className="px-4 py-2 text-sm font-medium text-green-600 hover:text-green-700">
                Change Password
              </button>
            </div>
          </div>
