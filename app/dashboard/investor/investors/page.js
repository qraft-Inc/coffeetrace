        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-coffee-600">
              Manage and view all investors in the system
            </p>
          </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-coffee-50 border-b border-coffee-200">
                    <tr>
                      <th className="px-6 py-3 text-left text-xs font-semibold text-coffee-900 uppercase tracking-wider">
                        Investor
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-semibold text-coffee-900 uppercase tracking-wider">
                        Email
                  ...
                  <tbody className="bg-white divide-y divide-coffee-100">
                    {filteredInvestors.map((investor) => {
                      const gainsPercentage = investor.totalInvested > 0
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm">
                              <p className="font-semibold text-coffee-900">
                                {investor.investmentCount || 0} total
                              </p>
